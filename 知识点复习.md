...
![前后端不分离](./img_django/depended_frontend_backend.png)
...
![前后端分离](./img_django/indepent_frontend_backend.png)
...
![drf_logo](./img_django/drf_logo.png)
...
![图书接口Web浏览页面](./img_django/图书接口Web浏览页面.png)

1）点击链接127.0.0.1:8000/books/ 可以访问**获取所有数据的接口**，呈现如下页面：

![查询所有图书信息1](./img_django/查询所有图书信息1.png)

![查询所有图书信息2](./img_django/查询所有图书页面2.png)

2）在页面底下表单部分填写图书信息，可以访问**添加新图书的接口**，保存新书：

![保存新图书](./img_django/保存新图书信息.png)

点击POST后，返回如下页面信息：

![保存图书返回信息](./img_django/保存图书返回信息.png)

3）在浏览器中输入网址127.0.0.1:8000/books/1/，可以访问**获取单一图书信息的接口**（id为1的图书），呈现如下页面：

![获取单一图书信息](./img_django/获取单一图书信息.png)

4）在页面底部表单中填写图书信息，可以访问**修改图书的接口**：

![修改图书信息](./img_django/修改图书信息.png)

点击PUT，返回如下页面信息：

![修改图书返回信息](./img_django/修改图书返回信息.png)

5）点击DELETE按钮，可以访问**删除图书的接口**：

![删除图书](./img_django/删除图书.png)

返回，如下页面：

![删除图书返回信息](./img_django/删除返回信息.png)
