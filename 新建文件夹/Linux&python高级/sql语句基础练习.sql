...
-- 增删改查(curd)
    ...
    -- 增加
        ...
        -- 向students表插入 一个学生信息
        insert into students values(0, "小李飞刀", 20, 188.22, "女", 1, "1990-01-01");
        insert into students values(null, "小李飞刀", 20, 162.29, "女", 1, "1990-01-01");
        insert into students values(default, "小李飞刀", 20, 155.01, "女", 1, "1990-01-01");
